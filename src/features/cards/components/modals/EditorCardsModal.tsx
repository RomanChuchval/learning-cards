...
import { TextFormatModal } from 'features/cards/components/modals/TextFormatModal'
import { ImageFormatModal } from 'features/cards/components/modals/ImageFormatModal'
...
export const EditorCardsModal: React.FC<EditorCardsModalPropsType> =
    ({ register, question, answer, questionImg, answerImg, control }) => {
